...
#if ODRIVE_FOC_INST != CONFIG_DRIVERS_FOC_INST
#  error Invalid configuration
#endif

/* Only 2-shunt configuration supported by board */

#if CONFIG_DRIVERS_FOC_SHUNTS != 2
...
#define ADC2_INJECTED  (CONFIG_DRIVERS_FOC_SHUNTS)
#define ADC2_REGULAR   (0)
#define ADC2_NCHANNELS (ADC2_INJECTED + ADC2_REGULAR)

#define ADC3_INJECTED  (CONFIG_DRIVERS_FOC_SHUNTS)
