...
ODrive is an open-source dual-motor FOC controller based on
the STMicro STM32F405RG and TI DRV8301 gate drivers.

See https://odriverobotics.com/ for further information.

For now we support only ODrive 3.6 56V.
...
^^^^^^^^^^^^^^
  ...
  ----------
    This is a board configuration that demonstrates the operation of two FOC
    insntances. This option uses float calculations for instance 0 and fixed16
    calculations for instnace 1.
