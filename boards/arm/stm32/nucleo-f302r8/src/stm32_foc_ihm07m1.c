...
{
#if defined(CONFIG_BOARD_STM32_IHM07M1_FLOAT)
  return board_ihm07m1_f32_initialize(&g_adc_cfg);
#elif defined(CONFIG_BOARD_STM32_IHM07M1_FIXED16)
  return board_ihm07m1_b16_initialize(&g_adc_cfg);
#else
#  error
#endif
}
