/****************************************************************************
 * boards/arm/stm32/common/src/stm32_foc_ihm07m1.c
 *
...
#define IPHASE_RATIO (-1.98f)
#define IPHASE_ADC   (ADC_TO_VOLT * IPHASE_RATIO)
#define IPHASE_MAX   (1.4f)
...
#ifdef CONFIG_BOARD_STM32_IHM07M1_FLOAT
/****************************************************************************
 * Name: board_ihm07m1_f32_initialize
 ****************************************************************************/

int board_ihm07m1_f32_initialize(FAR struct stm32_foc_adc_s *adc_cfg)
{
...
#endif  /* CONFIG_BOARD_STM32_IHM07M1_FLOAT */

#ifdef CONFIG_BOARD_STM32_IHM07M1_FIXED16
/****************************************************************************
 * Name: board_ihm07m1_b16_initialize
 ****************************************************************************/

int board_ihm07m1_b16_initialize(FAR struct stm32_foc_adc_s *adc_cfg)
{
  FAR struct foc_dev_s *foc         = NULL;
  int                   ret         = OK;
...
#endif  /* CONFIG_BOARD_STM32_IHM07M1_FIXED16 */
