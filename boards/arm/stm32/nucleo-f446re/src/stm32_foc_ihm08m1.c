/****************************************************************************
 * configs/nucleo-f446re/src/stm32_foc_ihm08m1.c
 *
...
#define ADC1_INJECTED  (CONFIG_POWER_FOC_SHUNTS)
...
{
#if defined(CONFIG_BOARD_STM32_IHM08M1_FLOAT)
  return board_ihm08m1_f32_initialize(&g_adc_cfg);
#elif defined(CONFIG_BOARD_STM32_IHM08M1_FIXED16)
  return board_ihm08m1_b16_initialize(&g_adc_cfg);
#else
#  error
#endif
}
