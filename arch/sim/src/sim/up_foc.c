...
struct sim_foc_data_s
{
  ...
  foc_current_t current[CONFIG_DRIVERS_FOC_PHASES];
...
static void sim_foc_notifier(FAR struct foc_dev_s *dev);
...
static struct sim_foc_data_s  g_sim_foc_data[CONFIG_DRIVERS_FOC_INST];
static struct sim_foc_board_s g_sim_foc_board[CONFIG_DRIVERS_FOC_INST];
...
static struct foc_lower_s g_sim_foc_lower[CONFIG_DRIVERS_FOC_INST];
                                ...
                                FAR foc_duty_t *duty)
{
  ...
  for (i = 0; i < CONFIG_DRIVERS_FOC_PHASES; i += 1)
    {
  ...
  pwrinfo("[%d %d]\n", duty[0], duty[1]);
#elif CONFIG_DRIVERS_FOC_PHASES == 3
  pwrinfo("[%d %d %d]\n", duty[0], duty[1], duty[2]);
#elif CONFIG_DRIVERS_FOC_PHASES == 4
...
#endif  /* CONFIG_DRIVERS_FOC_TRACE */
