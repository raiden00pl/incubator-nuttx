...
#  define b16toq31(b16_val) (ftoq31(b16tof(b16_val)))
#  define q31tob16(q31_val) (ftob16(q31tof(q31_val)))
#endif
...
struct cordic_ops_s
{
  /* Calculate CORDIC request */

  CODE int (*calculate)(FAR struct cordic_lowerhalf_s *lower,
