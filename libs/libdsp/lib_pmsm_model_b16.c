...
{
  static b16_t id_int = 0;
  static b16_t iq_int = 0;
  b16_t        tmp1   = 0;
  b16_t        tmp2   = 0;
  b16_t        tmp3   = 0;
  b16_t        tmp4   = 0;
  ...
  iq_int += b16mulb16(tmp6, model->phy.one_by_indq);
  ...
  id_int += b16mulb16(tmp5, model->phy.one_by_indd);

  /* Store currents */

  model->state.i_dq.q = iq_int;
  model->state.i_dq.d = id_int;
